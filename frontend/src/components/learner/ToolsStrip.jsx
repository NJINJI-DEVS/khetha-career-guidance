...
import { BookOpen, Compass, Target, Calculator, Check, ClipboardCheck, FileText } from 'lucide-react';
...
export function ToolsStrip({ t, go, profile }) {
  const tools = [
    ...
    { key: "tool:cv", icon: FileText, color: "#5B4B8A", label: "CV builder", done: !!profile.cvStarted },
  ];
  return (
    <div>
